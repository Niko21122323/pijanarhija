...
const aboutData: AboutData[] = [
  ...
  },
  {
    id: 2,
    title: "Приказната",
    text: "Добредојде во држава водена од алкохол, галама и хумор. Премиерот е исчезнат, законите не важат и сите имаат теорија за се. Бабата се кара во бус, шмизлата се слика а гасерот се трка по булевари.",
    delay: 0.4,
  },
  {
    id: 3,
